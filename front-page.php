		...
		<div class="servicerow">
			...
			<div class="service">
				...
				<div class="service__text">
					...
					<p>TCM focuses on the prevention of disease and uses herbs, diet and acupuncture, among other techniques to heal.  The main goal is to attain balanced qi or (vital energy) throughout the body. TCM is a whole-body medicine that studies the connection of mind, body and spirt. </p>
				</div>
			</div>
			<div class="service">
				...
				<div class="service__text">
					...
					<p>Botanical Medicine, also know as herbal medicine, uses plant parts as therapeutic treatment. Herbs can be taken in several forms, such as powders, capsules, teas, tinctures, topical applications. The numerous forms make it accessible to many.</p>
				</div>
			</div>
			<div class="service">
